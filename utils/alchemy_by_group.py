...
class AbsoluteAlchemicalFactory(object):
    ...
    def create_alchemical_system(self, reference_system, alchemical_regions,
        ...
        self.set_rbfe_exception=set_rbfe_exception # added by ylzhong
    ...
    def _alchemically_modify_NonbondedForce(self, reference_force, alchemical_regions, alchemical_regions_interactions):
        ...
        if self.set_rbfe_exception: # added by ylzhong
            tmp_keys = list(decouple_groups_nb.groups.keys())
            group_num_list = [int(i.replace('group','')) for i in tmp_keys]
            max_group = max(group_num_list)
            print(f'max_group = {max_group}')
            unit_A_atomset,unit_B_atomset,common_atomset = decouple_groups_nb.get_group(max_group-1)
...
#                naa_sterics_custom_nonbonded_force.addInteractionGroup(nonalchemical_atomset, already_decoupled_alchemical_atomset)
            ...
            if self.set_rbfe_exception: 
                aa_sterics_custom_nonbonded_force.addInteractionGroup(common_atomset,common_atomset)
                aa_sterics_custom_nonbonded_force.addInteractionGroup(unit_A_atomset,unit_A_atomset)
                aa_sterics_custom_nonbonded_force.addInteractionGroup(unit_B_atomset,unit_B_atomset)
                aa_sterics_custom_nonbonded_force.addInteractionGroup(common_atomset,unit_A_atomset)
                aa_sterics_custom_nonbonded_force.addInteractionGroup(common_atomset,unit_B_atomset)
                # pass
            else:
